...
export const ZH_CN_MESSAGES = {
    ...
    "auth.self_hosted_on_cloudflare_workers_your_data_is_yours": "cloudnote.cc · 云笔记服务",
    "auth.sign_in": "登录",
    "auth.sign_up": "注册",
...
`,
    ...
    // Landing page
    "landing.hero_title": "让每一个想法，都有迹可循。",
    "landing.hero_description": "私有云笔记服务。Markdown 编辑、多端实时同步、数据完全自主掌控。",
    "landing.get_started": "立即开始",
    "landing.features_label": "服务能力",
    "landing.features_title": "为高效写作而生",
    "landing.feature_markdown_title": "Markdown 编辑",
    "landing.feature_markdown_desc": "分屏实时预览，支持数学公式、Mermaid 图表、代码高亮等完整 Markdown 语法。",
    "landing.feature_sync_title": "多端实时同步",
    "landing.feature_sync_desc": "在所有设备间无缝同步。手机上记录灵感，电脑上继续编辑。",
    "landing.feature_backup_title": "多云备份",
    "landing.feature_backup_desc": "自动备份至 WebDAV 和 S3 兼容存储。你的数据，你的备份策略。",
    "landing.feature_private_title": "隐私优先",
    "landing.feature_private_desc": "自托管在你自己的基础设施上。无第三方追踪，无数据挖掘。",
    "landing.feature_mobile_title": "移动端就绪",
    "landing.feature_mobile_desc": "响应式设计，支持 PWA 安装。在任何设备上都能获得原生应用般的体验。",
    "landing.feature_security_title": "安全可靠",
    "landing.feature_security_desc": "开箱即用的双因素认证、会话管理和加密传输。",
